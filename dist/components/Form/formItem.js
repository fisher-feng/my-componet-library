...
var FormItem = function (props) {
    ...
    useEffect(function () {
        ...
        dispatch({ type: 'addField', name: name, value: { label: label, name: name, value: value, rules: rules || [], errors: errors || [], isValid: true } });
    }, []);
    ...
    var isRequire = rules === null || rules === void 0 ? void 0 : rules.some(function (rule) { return (typeof rule !== 'function') && rule.required; });
    ...
    return (React.createElement("div", { className: rowClass },
        label &&
            React.createElement("div", { className: "viking-form-item-label" },
        ...
        React.createElement("div", { className: "viking-form-item" },
            ...
            hasError &&
                React.createElement("div", { className: "viking-form-item-explain" },
